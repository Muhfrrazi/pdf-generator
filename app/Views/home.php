                    ...
                    <section class="panel controls">
                        ...
                        <div id="sourcePdfSection" class="section">
                            ...
                            <div class="file-input">
                                ...
                                <label class="file-button" for="pdfInput">Pilih file</label>
                                <span id="pdfFileName" class="file-name-inline">Belum ada file</span>
                            </div>
                        </div>
                        ...
                        <div id="watermarkTool" class="tool-section">
                            ...
                            <div id="imageControls" class="section hidden">
                                ...
                                <small style="color:red;">*Jika hanya logo hapus terlebih dahulu teks.</small>
                                <div class="file-input-row">
                                    <div class="file-input">
                                        <input id="imageInput" type="file" accept="image/png,image/jpeg" />
                                        <label class="file-button" for="imageInput">Pilih file</label>
                                        <span id="imageFileName" class="file-name-inline">Belum ada file</span>
                                    </div>
                                    <button id="clearImageBtn" class="icon-btn" type="button" aria-label="Hapus logo"
                                ...
                                <div class="grid two">
                                    <div>
                                        ...
                                        <div class="range">
                                            <input id="imgRotation" type="range" min="-90" max="90" value="0" />
                                            <span id="imgRotationVal">0deg</span>
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <div id="mergeTool" class="tool-section hidden">
                            <div class="section">
                                ...
                                <div class="file-input">
                                    ...
                                    <label class="file-button" for="mergeInput">Pilih file</label>
                                    <span id="mergeFileName" class="file-name-inline">Belum ada file</span>
                                </div>
                            </div>
